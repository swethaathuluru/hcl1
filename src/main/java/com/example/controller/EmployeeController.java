...
public ResponseEntity<Employee> update(@PathVariable int id, @RequestBody Employee e) throws CustomException {
...
public ResponseEntity<Employee> search(@PathVariable int id) throws CustomException {
...
public ResponseEntity<List<Project>> displayProject() throws CustomException {

	return new ResponseEntity<List<Project>>(service.displayProject(), HttpStatus.CREATED);
}
